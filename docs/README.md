...
| 06 | [Geometry & Collision v2](06-geometry-v2.md) — segment-based levels: rotation at any angle, curves, slopes, capsule movement | ✅ Written |
| 07 | [Map Entities & Wiring](07-map-entities.md) — placeable objects (jumpers, fields, teleporters, turrets, glass, sandworm…) and the activator signal model | ✅ Written |
