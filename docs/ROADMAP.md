...
Not-yet-scheduled work lives in **[BACKLOG.md](./BACKLOG.md)** — near-term known issues / tech
debt, plus the post-M10 feature & live-service idea parking lot. New feature ideas go there, not
here, so this document stays focused on the committed vision, architecture, and milestones.
